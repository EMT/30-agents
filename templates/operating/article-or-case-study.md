...
Guidance: describe the working implementation at a practical level. Include the autonomy level and human approval points where relevant.

## What Happened

TBD

Guidance: summarise the representative case, baseline comparison and stress case. Include failures, regressions or missing evidence.

## Verdict

TBD

Guidance: use `Confirmed`, `Refined` or `Rejected`. Copy the verdict reason and confidence from `evaluation.md`. Confirmed does not mean production-ready.
