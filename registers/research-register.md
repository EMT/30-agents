...
| Agent | Title | Hypothesis | Verdict | Verdict reason | Confidence | Recommended autonomy | Key evidence | Repository | Demo | Article / Case Study | Calibration notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| #01 | Workflow Friction Mapper | An agent can turn a recorded workflow walkthrough into a useful friction map before proposing any solution. | Not started | Pending evaluation. | TBD | TBD | Approved brief prepared; implementation not started. | TBD | TBD | TBD | 2026-08-14: renamed from "Friction Cartographer" for clarity. 2026-08-11: prepared repo deleted before implementation; will be re-scaffolded at build start. |
